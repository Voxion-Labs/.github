<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=rect&color=0:0b0000,50:330000,100:660000&height=160&section=header&text=Voxion%20Labs&fontSize=42&fontColor=ffffff&animation=fadeIn" />
</p>

<p align="center">
  <b>Independent Systems & Research Laboratory</b><br/>
  Focusing on deterministic architectures, zero-backend networks, and sandboxed AI kernels.
</p>

<p align="center">
  <img src="https://img.shields.io/badge/DETERMINISTIC%20SYSTEMS-2b0000?style=for-the-badge&logo=cplusplus&logoColor=ff4d4d" />
  <img src="https://img.shields.io/badge/WASM%20ARCHITECTURES-3b0000?style=for-the-badge&logo=webassembly&logoColor=ff6b6b" />
  <img src="https://img.shields.io/badge/AI%20ORCHESTRATION-4a0000?style=for-the-badge&logo=openai&logoColor=ff8787" />
  <img src="https://img.shields.io/badge/CYBER--DEFENSE-5c0000?style=for-the-badge&logo=shield&logoColor=ffaaaa" />
</p>
...
<table>
  <tr>
    ...
    <td width="48%" valign="top">
      ...
      Isolates the ranking kernel inside WebAssembly linear memory. Bypasses V8 garbage-collection to eliminate main-thread stutter. Recorded at 0.000 ms thread blocking with a GC-neutral 3.2 KB linear memory allocation.
      <br/><br/>
      <code>C++</code> &nbsp; <code>WebAssembly</code> &nbsp; <code>Zero-GC</code>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td width="48%" valign="top">
      ...
      <b>Distributed P2P Edge State Synchronization</b><br/><br/>
      Client-side engine demonstrating state synchronization across edge networks. Employs CRDT algorithmic conflict resolution. Benchmarked at 0.22 ms sync latency and 0.00% vector drift across P2P logical timestamps.
      <br/><br/>
      <code>Python</code> &nbsp; <code>CRDT</code> &nbsp; <code>P2P Telemetry</code>
    </td>
  </tr>
  <tr><td colspan="3"><br/></td></tr>
  <tr>
    ...
    <td width="48%" valign="top">
      ...
      <b>Cyber-Defense Dashboard · Zero-Backend Defense</b><br/><br/>
      Browser-native deterministic sandboxing kernel for detecting LLM prompt injections. Threat assessment executes strictly on-device via the Wasm kernel, preventing data ingress from exiting the local environment.
      <br/><br/>
      <code>WebAssembly</code> &nbsp; <code>Cyber-Defense</code> &nbsp; <code>Local-Only</code>
    </td>
  </tr>
</table>
